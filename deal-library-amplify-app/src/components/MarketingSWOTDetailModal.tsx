...
import { X, Target, Shield, AlertTriangle, TrendingUp, Bookmark, BookmarkCheck, CheckCircle, Copy, Download, Printer, CheckCircle2, Presentation, FileText } from 'lucide-react';
import { MarketingSWOT } from '@/types/deal';
import { useCardExport } from '@/hooks/useCardExport';
import { SlideView, SlideRenderer } from '@/components/slides';
import { generateMarketingSWOTSlides } from '@/lib/slideConfigs';
...
export function MarketingSWOTDetailModal({ swot, isOpen, onClose, onSaveCard, onUnsaveCard, isSaved }: MarketingSWOTDetailModalProps) {
  ...
  const slides = generateMarketingSWOTSlides(swot);
      ...
      >
        ...
        {viewMode === 'slides' ? (
          <div className="flex-1 min-h-[500px]">
            <SlideView
              slides={slides}
              cardType="marketing-swot"
              cardTitle={swot.companyName || 'Marketing SWOT'}
            >
