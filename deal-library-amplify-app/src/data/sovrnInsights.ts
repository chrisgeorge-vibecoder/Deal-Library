...
export const sovrnInsights: SovrnInsight[] = [
  ...
  // America's Top Retirement ZIP Codes Analysis - Verified from Launchpad Census + Commerce Data
  {
    id: 'silver-economy-1',
    headline: 'Sun City: The Original "Active Adult" Blueprint—Median Age 72.6, Income 36% Below National',
    didYouKnow: 'Sun City, Arizona (85351) pioneered the "active adult community" concept in 1960—and the data tells a surprising story. At median age 72.6 (vs. 41.6 national), Sun City has 75% higher age concentration than average. But median income is just $50,812—36% below the $78,797 national average. Despite lower incomes, Sun City generates 621,527 in commerce weight across 153 categories. These aren\'t wealthy retirees—they\'re fixed-income consumers who spend strategically.',
    marketingImplication: 'Sun City residents are value-maximizers, not luxury buyers. Lead with durability, warranties, and senior discounts. This audience responds to "more for less" positioning—not aspirational messaging. They\'ve earned the right to be frugal.',
    category: 'Geographic Markets',
    tags: ['sun-city', 'arizona', 'retirement', 'active-adult', 'silver-economy', 'value-conscious', 'seniors'],
    featured: true,
  },
  {
    id: 'silver-economy-2',
    headline: 'Naples 34102: The $1.4M Median Home Value Retirement Anomaly',
    didYouKnow: 'Naples, Florida (34102) breaks every retirement ZIP pattern. With a median home value of $1,420,358—363% above national average—and median income of $115,927 (+47%), this isn\'t a typical senior market. Yet commerce data shows only 12 active shopping categories with 8,820 total weight—the lowest engagement of any major retirement ZIP. These ultra-wealthy retirees buy in-person at luxury boutiques, not online.',
    marketingImplication: 'Naples 34102 is invisible to e-commerce. Digital marketing will underperform here. These consumers respond to white-glove service, private appointments, and concierge experiences. If you\'re not selling face-to-face or via referral, you\'re not reaching Naples.',
    category: 'Geographic Markets',
    tags: ['naples', 'florida', 'ultra-wealthy', 'UHNW', 'retirement', 'silver-economy', 'luxury', 'low-digital'],
    featured: true,
  },
  {
    id: 'silver-economy-3',
    headline: 'The Villages: America\'s Highest Commerce Weight Retirement ZIP—1.16M Total',
    didYouKnow: 'The Villages, Florida (32162) dominates retirement commerce with 1,159,880 total weight across 164 categories—87% higher than second-place St. George (803,096). With 54,019 population, median age 74.2, and $73,927 median income, The Villages generates $21.47 of commerce weight per resident—the highest per-capita retirement engagement in America. This single ZIP outspends many mid-size cities.',
    marketingImplication: 'The Villages is the "test market" for senior products. If it works in 32162, it scales nationally to 65+ audiences. Launch here first—the concentrated, high-engagement population delivers rapid signal on product-market fit for senior demographics.',
    category: 'Data Discoveries',
    tags: ['the-villages', 'florida', 'commerce', 'seniors', 'test-market', 'silver-economy', 'high-engagement'],
    featured: true,
  },
  {
    id: 'silver-economy-4',
    headline: 'Baby & Toddler Products Over-Index 151% in Retirement ZIPs—The Grandparent Economy Is Real',
    didYouKnow: 'The most surprising commerce signal in America\'s retirement havens: Baby & Toddler products over-index 151% vs. national average (5,706 avg weight vs. 3,788 national). The Villages alone generates 49,542 in Baby & Toddler commerce weight. GPS Tracking Devices follow at 165% over-index. Retirees are buying for grandchildren AND tracking their own movements—or their spouse\'s.',
    marketingImplication: 'Target retirement ZIPs for children\'s products—grandparents are the hidden premium buyers. Position baby gear as "gift-worthy with easy shipping." For GPS devices, lead with safety and family peace-of-mind. The buyer and the user are often 1,000+ miles apart.',
    category: 'Consumer Profiles',
    tags: ['grandparents', 'gifting', 'baby', 'toddler', 'silver-economy', 'gps', 'family', 'remote-grandparenting'],
    featured: true,
  },
  {
    id: 'silver-economy-5',
    headline: 'Mobile Phone Commerce 216% Over-Index in Retirement Havens—Seniors Are Power Users',
    didYouKnow: 'Retirement ZIPs over-index 216% on mobile phone purchases (3,103 avg weight vs. 1,439 national)—the highest over-index of any technology category. Tablet Computers follow at 148% (5,133 vs. 3,480). Seniors aren\'t technology-hesitant; they\'re technology-hungry. The stereotype of tech-averse elders is costing marketers access to the most lucrative device-buying demographic in America.',
    marketingImplication: 'Stop age-gating tech marketing. Retirement ZIPs outspend younger demographics on mobile devices 2:1. Lead with large screens, accessibility features, and video calling capabilities. "Stay connected to grandkids" beats "latest features" every time.',
    category: 'Data Discoveries',
    tags: ['mobile', 'phones', 'technology', 'seniors', 'tablets', 'digital-adoption', 'silver-economy', 'over-index'],
  },
  {
    id: 'silver-economy-6',
    headline: 'St. George Utah: Youngest "Retirement" ZIP at 37.8—The Outdoor Active Adult Alternative',
    didYouKnow: 'St. George, Utah (84770) breaks the retirement mold entirely: median age 37.8 (9% below national), yet it\'s consistently ranked a top retirement destination. With 47,226 population and 803,096 commerce weight across 157 categories, St. George attracts a younger, adventure-oriented semi-retired demographic. Outdoor Recreation over-indexes significantly while Golf under-indexes—the "national parks retirement" is replacing the "country club retirement."',
    marketingImplication: 'St. George represents the future of retirement: active, younger, outdoor-focused. Target with adventure gear, e-bikes, and experience travel—not golf clubs and shuffleboard. The emerging retiree wants Zion National Park proximity, not fairway access.',
    category: 'Lifestyle & Values',
    tags: ['st-george', 'utah', 'outdoor', 'national-parks', 'adventure', 'retirement', 'active-seniors', 'young-retirees'],
  },
  {
    id: 'silver-economy-7',
    headline: 'Marine Electronics: The Unexpected #1 Category in Retirement ZIPs—165% Over-Index',
    didYouKnow: 'Marine Electronics is the highest-weighted commerce category across all major retirement ZIPs: The Villages (57,840), Sun City (27,576), St. George (25,890). These landlocked or semi-coastal retirees over-index 165% on boat electronics. The insight? Retirees are the core boating demographic—they have time, disposable income, and lake/coastal second homes. Marine brands are sleeping on their best customers.',
    marketingImplication: 'Marine and boating brands should hyper-target retirement ZIPs—not coastal vacation destinations. Retirees own the boats; vacationers rent them. Target 32162, 85351, and 84770 for marine electronics, fishing gear, and boating accessories.',
    category: 'Consumer Profiles',
    tags: ['marine', 'boating', 'electronics', 'retirement', 'silver-economy', 'fishing', 'outdoor', 'unexpected'],
  },
  {
    id: 'silver-economy-8',
    headline: 'The 153,000-Population Silver Economy Cluster Generates 2.58M Commerce Weight',
    didYouKnow: 'The five major Retiree Haven ZIPs (The Villages, Sun City, Naples, Greenville, St. George) total just 152,063 residents—0.05% of U.S. population—yet generate 2,581,881 total commerce weight. That\'s 16.98 commerce weight per capita vs. approximately 3.0 national average. These 5 ZIP codes punch 5.7x above their population weight in digital commerce. Ignore them at your peril.',
    marketingImplication: 'A single campaign targeting these 5 ZIPs reaches the equivalent commerce value of 860,000+ average Americans. Build custom creative for each haven\'s unique profile: value messaging for Sun City, luxury for Naples, adventure for St. George, community for The Villages.',
    category: 'Data Discoveries',
    tags: ['retirement-corridor', 'silver-economy', 'zip-targeting', 'seniors', 'commerce-density', 'micro-markets', 'roi'],
  },
];
