...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  const showHeader = pathname === '/' || pathname === '/strategy-cards' || pathname === '/audience-insights' || pathname === '/market-pulse' || pathname === '/market-insights' || pathname === '/research' || pathname === '/deals' || pathname === '/audiences' || pathname === '/campaign-planner';
