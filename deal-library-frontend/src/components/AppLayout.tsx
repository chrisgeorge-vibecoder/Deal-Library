...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  const showHeader = pathname === '/' || pathname === '/strategy-cards' || pathname === '/audience-insights' || pathname === '/market-insights' || pathname === '/research' || pathname === '/deals' || pathname === '/audiences';
                  ...
                  {savedAudiences.length > 0 && (
                    <>
                      ...
                      {savedAudiences.map((card, index) => (
                        <div key={`${card.data.sovrnSegmentId || card.data.segment?.sovrnSegmentId}-${index}`} className="card p-4 flex items-center justify-between">
                          <div className="flex-1">
