import { Plus, Sparkles, Users, ShoppingCart, BookOpen, TrendingUp, Bookmark, Lightbulb, Sprout } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="p-4 border-b border-neutral-200">
        <button
          onClick={onNewChat}
          className="w-full flex items-center justify-center gap-2 px-4 py-3 min-h-[44px] bg-gradient-to-r from-brand-gold to-brand-orange text-brand-charcoal rounded-lg hover:shadow-sovrn transition-all duration-200 font-semibold touch-manipulation active:scale-98"
        >
